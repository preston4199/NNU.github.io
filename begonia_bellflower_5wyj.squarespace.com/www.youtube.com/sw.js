...
ytcfg.set({
    "EXPERIMENT_FLAGS": {
        ...
        "enable_innertube_home_debug_logging": true,
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20230120.00.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "clientName": "WEB",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20230120.00.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    const swPolicy = trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(ignored) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/82a4cf4f\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(swPolicy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/82a4cf4f\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}